...
INSERT INTO books (title, author, genre, rating, price, isbn, description, soldcopies, publisher) VALUES
...
CREATE TABLE IF NOT EXISTS book_ratings (
    ...
    comment TEXT,
    CONSTRAINT book_ratings_user_book_unique UNIQUE (user_id, book_id)
);
...
CREATE TABLE IF NOT EXISTS book_comments (
    ...
    comment TEXT,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT book_comments_user_id_unique UNIQUE (user_id, book_id)
);
...
CREATE TABLE IF NOT EXISTS WishlistItems (
    ...
    CONSTRAINT wishlistitems_wishlist_book_unique UNIQUE (wishlist_id, book_id)
);
...
--Andrew
--going to use Ramon's user table instead
...
(1, 'user1', 'password1', 'name1', 'email1@example.com', 'address1'),
(2, 'user2', 'password2', 'name2', 'email2@example.com', 'address2'),
(3, 'user3', 'password3', 'name3', 'email3@example.com', 'address3')
ON CONFLICT (username) DO NOTHING; */
...
INSERT INTO creditcards (cardtype, cardnumber, expirationdate, cvv, cardowner, user_id) VALUES
('Visa', '1111111111111111', '01/01', 123, 'User One', 1),
('MasterCard', '5555555555555555', '01/23', 456, 'User Two', 2)
