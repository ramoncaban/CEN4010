...
INSERT INTO profiles (username, password, name, emailaddress, homeaddress) VALUES
('user1', 'password1', 'name1', 'email1@example.com', 'address1'),
('user2', 'password2', 'name2', 'email2@example.com', 'address2'),
('user3', 'password3', 'name3', 'email3@example.com', 'address3')
